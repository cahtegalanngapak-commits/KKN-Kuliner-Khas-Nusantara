...
while not wlan.isconnected():
    time.sleep(0.5)
print("✅ Tersambung! Alamat IP:", wlan.ifconfig()[0])
...
<script>
const KONFIG = {nomorWA:'""" + NOMOR_WA + """', email:'""" + EMAIL_TUJUAN + """'};
function kirimWA(pesan) {
    const link = `https://wa.me/${KONFIG.nomorWA}?text=${encodeURIComponent(pesan)}`;
